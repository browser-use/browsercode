...
describe("tool.read truncation", () => {
  ...
  it.live("does not attach an HTML block page saved with a PDF extension", () =>
    Effect.gen(function* () {
      const dir = yield* tmpdirScoped()
      yield* put(path.join(dir, "blocked.pdf"), "<!doctype html><html><title>Access denied</title></html>")
